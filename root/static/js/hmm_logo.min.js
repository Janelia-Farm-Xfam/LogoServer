...
l[n][0],l[n][1],l[n][2],l[n][3])}f(this.contexts[d],g,this.height-15,5);f(this.contexts[d],g,this.height-30,5);f(this.contexts[d],g,this.height-45,5);0.7>this.zoom?0===h%5&&this.draw_column_divider({context_num:d,x:g,fontsize:10,column_num:p,ralign:!0}):this.draw_column_divider({context_num:d,x:g,fontsize:q,column_num:p});c=this.data.delete_probs[h-1];l=this.height-35;r="#ffffff";s="#555555";0.75>c?(r="#2171b5",s="#ffffff"):0.85>c?r="#6baed6":0.95>c&&(r="#bdd7e7");e(this.contexts[d],g,l,c,q,this.zoomed_column,
r,s);c=this.contexts[d];l=g;r=this.height;s=this.zoomed_column;n=this.data.insert_probs[h-1];m=r-20;v="#ffffff";w="#555555";0.1<n?(v="#d7301f",w="#ffffff"):0.05<n?v="#fc8d59":0.03<n&&(v="#fdcc8a");e(c,l,m,n,q,s,v,w);0.03<n&&f(c,l+s,r-30,-30-r,v);c=this.data.insert_lengths[h-1];l="#ffffff";r="#555555";9<c?(l="#d7301f",r="#ffffff"):7<c?l="#fc8d59":4<c&&(l="#fdcc8a");e(this.contexts[d],g,this.height-5,c,q,this.zoomed_column,l,r);g+=this.zoomed_column;p++}b(this.contexts[d],this.height-15,this.total_width);
