...
this.render_y_axis_label=function(){c(this.dom_element).parent().before('<canvas class="logo_yaxis" height="300" width="40"></canvas>');var a=c(this.called_on).find(".logo_yaxis");Math.abs(this.data.max_height);isNaN(this.data.min_height_obs)||parseInt(this.data.min_height_obs,10);l()||(a[0]=G_vmlCanvasManager.initElement(a[0]));a=a[0].getContext("2d");a.beginPath();a.moveTo(40,1);a.lineTo(30,1);a.moveTo(40,256);a.lineTo(30,256);a.moveTo(40,128);a.lineTo(30,128);a.lineWidth=1;a.strokeStyle="#666666";
a.stroke();a.fillStyle="#666666";a.textAlign="right";a.font="bold 10px Arial";a.textBaseline="top";a.fillText(this.data.max_height.toFixed(1),28,0);a.textBaseline="middle";a.fillText(parseFloat(this.data.max_height/2).toFixed(1),28,128);a.fillText("0",28,256);a.save();a.translate(5,this.height/2);a.rotate(-Math.PI/2);a.textAlign="center";a.font="normal 12px Arial";a.fillText("Information Content",1,0);a.restore()};this.render_x_axis_label();this.render_y_axis_label();this.render_with_text=function(a,
b,c,e){var j=0,i=a,g=0,g=Math.abs(this.data.max_height),q=isNaN(this.data.min_height_obs)?0:parseInt(this.data.min_height_obs,10),g=g+Math.abs(q),g=Math.round(100*Math.abs(this.data.max_height)/g);Math.round(256*g/100);b+3<=this.end&&(b+=3);for(g=a;g<=b;g++){if(this.data.mmline&&1===this.data.mmline[g-1])this.contexts[c].fillStyle="#cccccc",this.contexts[c].fillRect(j,10,this.zoomed_column,this.height-40);else if(a=this.data.height_arr[g-1])for(var q=0,m=a.length,n=0,n=0;n<m;n++){var r=a[n].split(":",
2),t=j+this.zoomed_column/2,h=(0.0024*this.zoomed_column+0.0405).toFixed(2),p=null;if(0.01<r[1]){var p=parseFloat(r[1])/this.data.max_height,u=254-q,x=258*p;l()||(u+=x*(p/2));this.contexts[c].font="bold 350px Arial";this.contexts[c].textAlign="center";this.contexts[c].fillStyle=this.colors[r[0]];this.contexts[c].transform(h,0,0,p,t,u);this.contexts[c].fillText(r[0],0,0);this.contexts[c].setTransform(1,0,0,1,0,0);q+=x}}k(this.contexts[c],j,this.height-15,5);k(this.contexts[c],j,this.height-30,5);k(this.contexts[c],
j,this.height-45,5);0.7>this.zoom?0===g%5&&this.draw_column_divider({context_num:c,x:j,fontsize:10,column_num:i,ralign:!0}):this.draw_column_divider({context_num:c,x:j,fontsize:e,column_num:i});a=this.data.delete_probs[g-1]/100;q=this.height-35;m="#ffffff";n="#555555";0.25<a?(m="#2171b5",n="#ffffff"):0.15<a?m="#6baed6":0.05<a&&(m="#bdd7e7");d(this.contexts[c],j,q,a,e,this.zoomed_column,m,n);a=this.contexts[c];q=j;m=this.height;n=this.zoomed_column;r=this.data.insert_probs[g-1]/100;t=m-20;h="#ffffff";
p="#555555";0.1<r?(h="#d7301f",p="#ffffff"):0.05<r?h="#fc8d59":0.03<r&&(h="#fdcc8a");d(a,q,t,r,e,n,h,p);0.1<r&&k(a,q+n,m-30,-30-m,h);a=this.data.insert_lengths[g-1];q="#ffffff";m="#555555";9<a?(q="#d7301f",m="#ffffff"):7<a?q="#fc8d59":4<a&&(q="#fdcc8a");d(this.contexts[c],j,this.height-5,a,e,this.zoomed_column,q,m);j+=this.zoomed_column;i++}f(this.contexts[c],this.height-15,this.total_width);f(this.contexts[c],this.height-30,this.total_width);f(this.contexts[c],this.height-45,this.total_width);f(this.contexts[c],
0,this.total_width)};this.draw_column_divider=function(a){var b=a.ralign?a.x+this.zoomed_column:a.x,f=a.ralign?a.x+2:a.x;k(this.contexts[a.context_num],b,this.height-30,-30-this.height,"#dddddd");k(this.contexts[a.context_num],b,0,5);var b=this.contexts[a.context_num],c=this.zoomed_column,d=a.column_num,i=a.ralign;b.font=a.fontsize+"px Arial";b.textAlign=i?"right":"center";b.fillStyle="#666666";b.fillText(d,f+c/2,10)};this.render_with_rects=function(a,b,c){var d=0,j=a,i=0,i=Math.abs(this.data.max_height),
g=Math.abs(this.data.min_height_obs),i=Math.round(100*Math.abs(this.data.max_height)/(i+g));Math.round(256*i/100);g=10;for(i=a;i<=b;i++){if(this.data.mmline&&1===this.data.mmline[i-1])this.contexts[c].fillStyle="#cccccc",this.contexts[c].fillRect(d,10,this.zoomed_column,this.height-40);else for(var a=this.data.height_arr[i-1],e=0,m=a.length,n=0,n=0;n<m;n++){var r=a[n].split(":",2);if(0.01<r[1]){var l=parseFloat(r[1])/this.data.max_height,h=d,l=256*l,p=256-e-l;this.contexts[c].fillStyle=this.colors[r[0]];
this.contexts[c].fillRect(h,p,this.zoomed_column,l);e+=l}}0.2>this.zoom?g=20:0.3>this.zoom&&(g=10);0===i%g&&(k(this.contexts[c],d+this.zoomed_column,this.height-30,parseFloat(this.height),"#dddddd"),k(this.contexts[c],d+this.zoomed_column,0,5),a=this.contexts[c],e=d-2,m=this.zoomed_column,n=j,a.font="10px Arial",a.textAlign="right",a.fillStyle="#666666",a.fillText(n,e+m/2,10));a=this.contexts[c];e=d;m=this.height-42;n=this.zoomed_column;r=this.data.insert_probs[i-1]/100;h=this.data.insert_lengths[i-
1];l=this.data.delete_probs[i-1]/100;p="#ffffff";0.1<r?p="#d7301f":0.05<r?p="#fc8d59":0.03<r&&(p="#fdcc8a");a.fillStyle=p;a.fillRect(e,m+12,n,10);p="#ffffff";9<h?p="#d7301f":7<h?p="#fc8d59":4<h&&(p="#fdcc8a");a.fillStyle=p;a.fillRect(e,m+24,n,10);p="#ffffff";0.25<l?p="#2171b5":0.15<l?p="#6baed6":0.05<l&&(p="#bdd7e7");a.fillStyle=p;a.fillRect(e,m,n,10);f(this.contexts[c],this.height-45,this.total_width);f(this.contexts[c],0,this.total_width);d+=this.zoomed_column;j++}};this.toggle_scale=function(){var a=
this.current_column();this.data.max_height=this.data.max_height===this.data.max_height_obs?this.data.max_height_theory:this.data.max_height_obs;this.rendered=[];c(this.called_on).find(".logo_yaxis").remove();this.render_y_axis_label();this.scrollme.reflow();this.scrollToColumn(a+1);this.scrollToColumn(a)};this.current_column=function(){var a=this.scrollme.scroller.getValues().left,b=this.column_width*this.zoom,a=a/b,b=c(this.called_on).find(".logo_container").width()/b/2;return Math.ceil(a+b)};this.change_zoom=
function(a){var b=0.3;a.target?b=a.target:a.distance&&(b=(parseFloat(this.zoom)-parseFloat(a.distance)).toFixed(1),"+"===a.direction&&(b=(parseFloat(this.zoom)+parseFloat(a.distance)).toFixed(1)));1<b?b=1:0.1>b&&(b=0.1);c(this.called_on).find(".logo_graphic").width()*b/this.zoom>c(this.called_on).find(".logo_container").width()&&(a.column?(this.zoom=b,this.render({zoom:this.zoom}),this.scrollme.reflow(),b=this.coordinatesFromColumn(a.column),this.scrollme.scroller.scrollTo(b-a.offset)):(a=this.current_column(),
this.zoom=b,this.render({zoom:this.zoom}),this.scrollme.reflow(),this.scrollToColumn(a)));return this.zoom};this.columnFromCoordinates=function(a){return Math.ceil(a/(this.column_width*this.zoom))};this.coordinatesFromColumn=function(a){return(a-1)*this.column_width*this.zoom+this.column_width*this.zoom/2};this.scrollToColumn=function(a,b){var f=c(this.called_on).find(".logo_container").width()/2,d=this.coordinatesFromColumn(a);this.scrollme.scroller.scrollTo(d-f,0,b)}}var h=null;c.fn.hmm_logo=function(b){var f=
null,k=c('<div class="logo_graphic">');if(l()){b=b||{};c(this).append(c('<div class="logo_container">').append(k).append('<div class="logo_divider">'));b.data=c(this).data("logo");if(null===b.data)return;b.dom_element=k;b.called_on=this;var d=c('<form class="logo_form"><fieldset><label for="position">Column number</label><input type="text" name="position" class="logo_position"></input><button class="button logo_change">Go</button></fieldset></form>'),f=new e(b);f.render(b);f.scale_height_enabled&&
f.data.max_height_obs<f.data.max_height_theory&&d.append('<button class="logo_scale button">Toggle Scale</button><br/>');f.zoom_enabled&&d.append('<button class="logo_zoomout button">-</button><button class="logo_zoomin button">+</button>');c(this).append(d);c(this).find(".logo_reset").bind("click",function(a){a.preventDefault();a=f;a.change_zoom({target:a.default_zoom})});c(this).find(".logo_change").bind("click",function(a){a.preventDefault()});c(this).find(".logo_zoomin").bind("click",function(a){a.preventDefault();
f.change_zoom({distance:0.1,direction:"+"})});c(this).find(".logo_zoomout").bind("click",function(a){a.preventDefault();f.change_zoom({distance:0.1,direction:"-"})});c(this).find(".logo_scale").bind("click",function(a){a.preventDefault();f.toggle_scale()});c(this).find(".logo_position").bind("change",function(){var a=f;this.value.match(/^\d+$/m)&&a.scrollToColumn(this.value,1)});k.bind("dblclick",function(a){var b=f,d=c(this).offset(),d=parseInt(a.pageX-d.left,10),a=a.pageX-c(this).parent().offset().left,
d=b.columnFromCoordinates(d);1>b.zoom?b.change_zoom({target:1,offset:a,column:d}):b.change_zoom({target:0.3,offset:a,column:d})});b.column_info&&k.bind("click",function(a){var d=f,k=c('<table class="logo_col_info"></table>'),e="<tr>",j="",i=c(this).offset(),a=parseInt(a.pageX-i.left,10);c(this).parent().offset();var d=d.columnFromCoordinates(a),d=f.data.height_arr[d-1].slice(0).reverse(),i=Math.ceil(d.length/5),g=a=0,g="Probability";f.data.height_calc&&"score"===f.data.height_calc&&(g="Score");for(a=
0;a<i;a++)e+="<th>Residue</th><th>"+g+"</th>";k.append(c(e+"</tr>"));for(a=0;5>a;a++){j+="<tr>";for(g=a;d[g];)e=d[g].split(":",2),j+="<td>"+e[0]+"</td><td>"+e[1]+"</td>",g+=5;j+="</tr>"}k.append(c(j));c(b.column_info).empty().append(k)});c(document).bind(this.attr("id")+".scrolledTo",function(a,b){f.render({target:b})});c(document).keydown(function(a){a.ctrlKey||((61===a.which||107===a.which)&&f.change_zoom({distance:0.1,direction:"+"}),(109===a.which||0===a.which)&&f.change_zoom({distance:0.1,direction:"-"}))})}else c("#logo").replaceWith(c("#no_canvas").html());
return f}})(jQuery);/*
