...
5E3;this.scrollme=null;this.previous_target=0;this.rendered=[];this.previous_zoom=0;this.render=function(b){if(this.data){var b=b||{},a=b.zoom||this.zoom,e=b.target||1,g=c(this.dom_element).parent().width(),d=1,h=0;if(e!==this.previous_target){this.previous_target=e;b.start&&(this.start=b.start);b.end&&(this.end=b.end);0.1>=a?a=0.1:1<=a&&(a=1);this.zoom=a;var b=this.end||this.data.height_arr.length,k=this.start||1,b=b>this.data.height_arr.length?this.data.height_arr.length:b,b=b<k?k:b,k=k>b?b:k,k=
...
"px"});g=Math.ceil(this.total_width/this.canvas_width);this.columns_per_canvas=Math.ceil(this.canvas_width/this.zoomed_column);this.previous_zoom!==this.zoom&&(c(this.dom_element).find("canvas").remove(),this.previous_zoom=this.zoom,this.rendered=[]);this.canvases=[];this.contexts=[];for(h=0;h<g;h++){var f=this.columns_per_canvas*h+k,m=f+this.columns_per_canvas-1;m>b&&(m=b);var n=(m-f+1)*this.zoomed_column;n>d&&(d=n);var p=d*h,s=p+n;if(e<s+s/2&&e>p-p/2&&1!==this.rendered[h]){var p=this.canvases,j=
h,r=this.dom_element,t=this.height,x=n,A=h,B=d,u=c(r).find("#canv_"+A);u.length||(c(r).append('<canvas class="canvas_logo" id="canv_'+A+'"  height="'+t+'" width="'+x+'" style="left:'+B*A+'px"></canvas>'),u=c(r).find("#canv_"+A));c(u).attr("width",x).attr("height",t);i()||(u[0]=G_vmlCanvasManager.initElement(u[0]));p[j]=u[0];this.contexts[h]=this.canvases[h].getContext("2d");this.contexts[h].setTransform(1,0,0,1,0,0);this.contexts[h].clearRect(0,0,n,this.height);this.contexts[h].fillStyle="#ffffff";
this.contexts[h].fillRect(0,0,s,this.height);12<this.zoomed_column?(n=parseInt(10*a,10),n=10<n?10:n,this.render_with_text(f,m,h,n)):this.render_with_rects(f,m,h);this.rendered[h]=1}}!this.scrollme&&i()&&(this.scrollme=new EasyScroller(c(this.dom_element)[0],{scrollingX:1,scrollingY:0,eventTarget:this.called_on}));1!==e&&i()&&this.scrollme.reflow()}}};this.render_x_axis_label=function(){c(this.dom_element).parent().before('<div class="logo_xaxis" class="centered" style="margin-left:40px"><p class="xaxis_text" style="width:10em;margin:1em auto">Model Position</p></div>')};
this.render_y_axis_label=function(){c(this.dom_element).parent().before('<canvas class="logo_yaxis" height="300" width="40"></canvas>');var b=c(this.called_on).find(".logo_yaxis");Math.abs(this.data.max_height);i()||(b[0]=G_vmlCanvasManager.initElement(b[0]));b=b[0].getContext("2d");b.beginPath();b.moveTo(40,1);b.lineTo(30,1);b.moveTo(40,271);b.lineTo(30,271);b.moveTo(40,135.5);b.lineTo(30,135.5);b.lineWidth=1;b.strokeStyle="#666666";b.stroke();b.fillStyle="#666666";b.textAlign="right";b.font="bold 10px Arial";
b.textBaseline="top";b.fillText(this.data.max_height.toFixed(1),28,0);b.textBaseline="middle";b.fillText(parseFloat(this.data.max_height/2).toFixed(1),28,135.5);b.fillText("0",28,271);b.save();b.translate(5,this.height/2);b.rotate(-Math.PI/2);b.textAlign="center";b.font="normal 12px Arial";b.fillText("Information Content",1,0);b.restore()};this.render_x_axis_label();this.render_y_axis_label();this.render_with_text=function(b,a,c,f){var l=0,h=b,k=0,k=Math.abs(this.data.max_height)+Math.abs(this.data.min_height_obs),
k=Math.round(100*Math.abs(this.data.max_height)/k);Math.round(271*k/100);a+3<=this.end&&(a+=3);for(k=b;k<=a;k++){if(this.data.mmline&&1===this.data.mmline[k-1])this.contexts[c].fillStyle="#cccccc",this.contexts[c].fillRect(l,10,this.zoomed_column,this.height-40);else if(b=this.data.height_arr[k-1])for(var q=0,m=b.length,n=0,n=0;n<m;n++){var p=b[n].split(":",2),s=l+this.zoomed_column/2,j=(0.0024*this.zoomed_column+0.0405).toFixed(2),r=null;if(0.01<p[1]){var r=parseFloat(p[1])/this.data.max_height,
t=269-q,x=258*r;i()||(t+=x*(r/2));this.contexts[c].font="bold 350px Arial";this.contexts[c].textAlign="center";this.contexts[c].fillStyle=this.colors[p[0]];this.contexts[c].transform(j,0,0,r,s,t);this.contexts[c].fillText(p[0],0,0);this.contexts[c].setTransform(1,0,0,1,0,0);q+=x}}g(this.contexts[c],l,this.height-15,5);g(this.contexts[c],l,this.height-30,5);0.7>this.zoom?0===k%5&&this.draw_column_divider({context_num:c,x:l,fontsize:10,column_num:h,ralign:!0}):this.draw_column_divider({context_num:c,
x:l,fontsize:f,column_num:h});b=this.contexts[c];q=l;m=this.height;n=this.zoomed_column;p=this.data.insert_probs[k-1]/100;s=m-20;j="#ffffff";r="#000000";0.1<p?(j="#d7301f",r="#ffffff"):0.05<p?j="#fc8d59":0.03<p&&(j="#fdcc8a");d(b,q,s,p,f,n,j,r);0.1<p&&g(b,q+n,m-30,-30-m,j);b=this.data.insert_lengths[k-1];q="#ffffff";m="#000000";9<b?(q="#2171b5",m="#ffffff"):7<b?q="#6baed6":4<b&&(q="#bdd7e7");d(this.contexts[c],l,this.height-5,b,f,this.zoomed_column,q,m);l+=this.zoomed_column;h++}e(this.contexts[c],
this.height-15,this.total_width);e(this.contexts[c],this.height-30,this.total_width);e(this.contexts[c],0,this.total_width)};this.draw_column_divider=function(b){var a=b.ralign?b.x+this.zoomed_column:b.x,e=b.ralign?b.x+2:b.x;g(this.contexts[b.context_num],a,this.height-30,-30-this.height,"#dddddd");g(this.contexts[b.context_num],a,0,5);var a=this.contexts[b.context_num],c=this.zoomed_column,d=b.column_num,h=b.ralign;a.font=b.fontsize+"px Arial";a.textAlign=h?"right":"center";a.fillStyle="#666666";
a.fillText(d,e+c/2,10)};this.render_with_rects=function(b,a,c){var d=0,f=b,h=0,h=Math.abs(this.data.max_height),k=Math.abs(this.data.min_height_obs),h=Math.round(100*Math.abs(this.data.max_height)/(h+k));Math.round(271*h/100);k=10;for(h=b;h<=a;h++){if(this.data.mmline&&1===this.data.mmline[h-1])this.contexts[c].fillStyle="#cccccc",this.contexts[c].fillRect(d,10,this.zoomed_column,this.height-40);else for(var b=this.data.height_arr[h-1],i=0,m=b.length,n=0,n=0;n<m;n++){var p=b[n].split(":",2);if(0.01<
p[1]){var j=parseFloat(p[1])/this.data.max_height,w=d,j=271*j,r=271-i-j;this.contexts[c].fillStyle=this.colors[p[0]];this.contexts[c].fillRect(w,r,this.zoomed_column,j);i+=j}}0.2>this.zoom?k=20:0.3>this.zoom&&(k=10);0===h%k&&(g(this.contexts[c],d+this.zoomed_column,this.height-30,parseFloat(this.height),"#dddddd"),g(this.contexts[c],d+this.zoomed_column,0,5),b=this.contexts[c],i=d-2,m=this.zoomed_column,n=f,b.font="10px Arial",b.textAlign="right",b.fillStyle="#666666",b.fillText(n,i+m/2,10));b=this.contexts[c];
i=d;m=this.height-28;n=this.zoomed_column;p=this.data.insert_probs[h-1]/100;w=this.data.insert_lengths[h-1];j="#ffffff";0.1<p?j="#d7301f":0.05<p?j="#fc8d59":0.03<p&&(j="#fdcc8a");b.fillStyle=j;b.fillRect(i,m,n,10);j="#ffffff";9<w?j="#2171b5":7<w?j="#6baed6":4<w&&(j="#bdd7e7");b.fillStyle=j;b.fillRect(i,m+12,n,10);e(this.contexts[c],this.height-30,this.total_width);e(this.contexts[c],0,this.total_width);d+=this.zoomed_column;f++}};this.toggle_scale=function(){var b=this.current_column();this.data.max_height=
...
this.scrollme.reflow(),this.scrollToColumn(b)));return this.zoom};this.columnFromCoordinates=function(b){return Math.ceil(b/(this.column_width*this.zoom))};this.coordinatesFromColumn=function(b){return(b-1)*this.column_width*this.zoom+this.column_width*this.zoom/2};this.scrollToColumn=function(b,a){var e=c(this.called_on).find(".logo_container").width()/2,d=this.coordinatesFromColumn(b);this.scrollme.scroller.scrollTo(d-e,0,a)}}var j=null;c.fn.hmm_logo=function(a){var e=null,g=c('<div class="logo_graphic">');
if(i()){a=a||{};c(this).append(c('<div class="logo_container">').append(g).append('<div class="logo_divider">'));a.data=c(this).data("logo");if(null===a.data)return;a.dom_element=g;a.called_on=this;var d=c('<form class="logo_form"><fieldset><label for="position">Column number</label><input type="text" name="position" class="logo_position"></input><button class="button logo_change">Go</button></fieldset></form>'),e=new f(a);e.render(a);e.scale_height_enabled&&e.data.max_height_obs<e.data.max_height_theory&&
d.append('<button class="logo_scale button">Toggle Scale</button><br/>');e.zoom_enabled&&d.append('<button class="logo_zoomout button">-</button><button class="logo_zoomin button">+</button>');c(this).append(d);c(this).find(".logo_reset").bind("click",function(b){b.preventDefault();b=e;b.change_zoom({target:b.default_zoom})});c(this).find(".logo_change").bind("click",function(b){b.preventDefault()});c(this).find(".logo_zoomin").bind("click",function(b){b.preventDefault();e.change_zoom({distance:0.1,
direction:"+"})});c(this).find(".logo_zoomout").bind("click",function(b){b.preventDefault();e.change_zoom({distance:0.1,direction:"-"})});c(this).find(".logo_scale").bind("click",function(b){b.preventDefault();e.toggle_scale()});c(this).find(".logo_position").bind("change",function(){var b=e;this.value.match(/^\d+$/m)&&b.scrollToColumn(this.value,1)});g.bind("dblclick",function(b){var a=e,d=c(this).offset(),d=parseInt(b.pageX-d.left,10),b=b.pageX-c(this).parent().offset().left,d=a.columnFromCoordinates(d);
1>a.zoom?a.change_zoom({target:1,offset:b,column:d}):a.change_zoom({target:0.3,offset:b,column:d})});a.column_info&&g.bind("click",function(b){var d=e,g=c('<table class="logo_col_info"></table>'),f="<tr>",l="",h=c(this).offset(),b=parseInt(b.pageX-h.left,10);c(this).parent().offset();for(var d=d.columnFromCoordinates(b),d=e.data.height_arr[d-1].slice(0).reverse(),k=Math.ceil(d.length/5),b=h=b=0;b<k;b++)f+="<th>Residue</th><th>Score</th>";g.append(c(f+"</tr>"));for(b=0;5>b;b++){l+="<tr>";for(h=b;d[h];)f=
d[h].split(":",2),l+="<td>"+f[0]+"</td><td>"+f[1]+"</td>",h+=5;l+="</tr>"}g.append(c(l));c(a.column_info).empty().append(g)});c(document).bind(this.attr("id")+".scrolledTo",function(b,a){e.render({target:a})});c(document).keydown(function(b){b.ctrlKey||((61===b.which||107===b.which)&&e.change_zoom({distance:0.1,direction:"+"}),(109===b.which||0===b.which)&&e.change_zoom({distance:0.1,direction:"-"}))})}else c("#logo").replaceWith(c("#no_canvas").html());return e}})(jQuery);/*
...
*/
(function(c){if(!c.requestAnimationFrame){var i=Date.now||function(){return+new Date},f=Object.keys||function(b){var a={},e;for(e in b)a[e]=!0;return a},j=Object.empty||function(b){for(var a in b)return!1;return!0},a;a:{a=["webkit","moz","o","ms"];for(var e=0;4>e;e++)if(null!=c[a[e]+"RequestAnimationFrame"]){a=a[e];break a}a=void 0}if(a)c.requestAnimationFrame=c[a+"RequestAnimationFrame"],c.cancelRequestAnimationFrame=c[a+"CancelRequestAnimationFrame"];else{var g={},d=1,b=null;c.requestAnimationFrame=
function(a){var e=d++;g[e]=a;null===b&&(b=setTimeout(function(){var a=i(),e=g,c=f(e);g={};b=null;for(var d=0,j=c.length;d<j;d++)e[c[d]](a)},1E3/60));return e};c.cancelRequestAnimationFrame=function(a){delete g[a];j(g)&&(clearTimeout(b),b=null)}}}})(this);
(function(c){var i=Date.now||function(){return+new Date},f={},j=1;c.core?core.effect||(core.effect={}):c.core={effect:{}};core.effect.Animate={stop:function(a){var e=null!=f[a];e&&(f[a]=null);return e},isRunning:function(a){return null!=f[a]},start:function(a,e,c,d,b,y){var z=i(),v=z,l=0,h=0,k=j++;y||(y=document.body);if(0===k%20){var q={},m;for(m in f)q[m]=!0;f=q}var n=function(j){var j=!0!==j,m=i();if(!f[k]||e&&!e(k))f[k]=null,c&&c(60-h/((m-z)/1E3),k,!1);else{if(j)for(var q=Math.round((m-v)/(1E3/
60))-1,r=0;r<Math.min(q,4);r++)n(!0),h++;d&&(l=(m-z)/d,1<l&&(l=1));q=b?b(l):l;(!1===a(q,m,j)||1===l)&&j?(f[k]=null,c&&c(60-h/((m-z)/1E3),k,1===l||null==d)):j&&(v=m,requestAnimationFrame(n,y))}};f[k]=!0;requestAnimationFrame(n,y);return k}}})(this);
var EasyScroller=function(c,i){this.content=c;this.container=c.parentNode;this.options=i||{};var f=this;this.scroller=new Scroller(function(c,a,e){f.render(c,a,e)},i);this.bindEvents();this.content.style[EasyScroller.vendorPrefix+"TransformOrigin"]="left top";this.reflow()};
EasyScroller.prototype.render=function(){var c=document.documentElement.style,i;window.opera&&"[object Opera]"===Object.prototype.toString.call(opera)?i="presto":"MozAppearance"in c?i="gecko":"WebkitAppearance"in c?i="webkit":"string"===typeof navigator.cpuClass&&(i="trident");c=EasyScroller.vendorPrefix={trident:"ms",gecko:"Moz",webkit:"Webkit",presto:"O"}[i];i=document.createElement("div");var f=c+"Transform";return void 0!==i.style[c+"Perspective"]?function(c,a,e){this.content.style[f]="translate3d("+
-c+"px,"+-a+"px,0) scale("+e+")"}:void 0!==i.style[f]?function(c,a,e){this.content.style[f]="translate("+-c+"px,"+-a+"px) scale("+e+")"}:function(c,a,e){this.content.style.marginLeft=c?-c/e+"px":"";this.content.style.marginTop=a?-a/e+"px":"";this.content.style.zoom=e||""}}();
...
(new Date).getTime(),f.scale)},!1),document.addEventListener("touchend",function(){c.scroller.doTouchEnd((new Date).getTime())},!1),document.addEventListener("touchcancel",function(){c.scroller.doTouchEnd((new Date).getTime())},!1);else{var i=!1;$(this.container).bind("mousedown",function(f){f.target.tagName.match(/input|textarea|select/i)||(c.scroller.doTouchStart([{pageX:f.pageX,pageY:f.pageY}],(new Date).getTime()),i=!0,f.preventDefault())});$(document).bind("mousemove",function(f){i&&(c.scroller.doTouchMove([{pageX:f.pageX,
pageY:f.pageY}],(new Date).getTime()),i=!0)});$(document).bind("mouseup",function(){i&&(c.scroller.doTouchEnd((new Date).getTime()),i=!1)});$(this.container).bind("mousewheel",function(f){c.options.zooming&&(c.scroller.doMouseZoom(f.wheelDelta,(new Date).getTime(),f.pageX,f.pageY),f.preventDefault())})}};var Scroller;
(function(){Scroller=function(a,e){this.__callback=a;this.options={scrollingX:!0,scrollingY:!0,animating:!0,bouncing:!0,locking:!0,paging:!1,snapping:!1,zooming:!1,minZoom:0.5,maxZoom:3,eventTarget:null};for(var c in e)this.options[c]=e[c]};var c=function(a){return Math.pow(a-1,3)+1},i=function(a){return 1>(a/=0.5)?0.5*Math.pow(a,3):0.5*(Math.pow(a-2,3)+2)},f={__isSingleTouch:!1,__isTracking:!1,__isGesturing:!1,__isDragging:!1,__isDecelerating:!1,__isAnimating:!1,__clientLeft:0,__clientTop:0,__clientWidth:0,
...
!0;this.__isDragging=!b;this.__isSingleTouch=b;this.__positions=[]},doTouchMove:function(a,c,g){if(null==a.length)throw Error("Invalid touch list: "+a);c instanceof Date&&(c=c.valueOf());if("number"!==typeof c)throw Error("Invalid timestamp value: "+c);if(this.__isTracking){var d;2===a.length?(d=Math.abs(a[0].pageX+a[1].pageX)/2,a=Math.abs(a[0].pageY+a[1].pageY)/2):(d=a[0].pageX,a=a[0].pageY);var b=this.__positions;if(this.__isDragging){var f=d-this.__lastTouchLeft,j=a-this.__lastTouchTop,i=this.__scrollLeft,
l=this.__scrollTop,h=this.__zoomLevel;if(null!=g&&this.options.zooming){var k=h,h=h/this.__lastScale*g,h=Math.max(Math.min(h,this.options.maxZoom),this.options.minZoom);if(k!==h){var q=d-this.__clientLeft,m=a-this.__clientTop,i=(q+i)*h/k-q,l=(m+l)*h/k-m;this.__computeScrollMax(h)}}if(this.__enableScrollX&&(i-=f,k=this.__maxScrollLeft,i>k||0>i))i=this.options.bouncing?i+f/2:i>k?k:0;if(this.__enableScrollY&&(l-=j,f=this.__maxScrollTop,l>f||0>l))this.options.bouncing?(l+=j/2,!this.__enableScrollX&&null!=
this.__refreshHeight&&(!this.__refreshActive&&l<=-this.__refreshHeight?(this.__refreshActive=!0,this.__refreshActivate&&this.__refreshActivate()):this.__refreshActive&&l>-this.__refreshHeight&&(this.__refreshActive=!1,this.__refreshDeactivate&&this.__refreshDeactivate()))):l=l>f?f:0;60<b.length&&b.splice(0,30);b.push(i,l,c);this.__publish(i,l,h)}else j=this.options.locking?3:0,i=Math.abs(d-this.__initialTouchLeft),l=Math.abs(a-this.__initialTouchTop),this.__enableScrollX=this.options.scrollingX&&
i>=j,this.__enableScrollY=this.options.scrollingY&&l>=j,b.push(this.__scrollLeft,this.__scrollTop,c),this.__isDragging=(this.__enableScrollX||this.__enableScrollY)&&(5<=i||5<=l);this.__lastTouchLeft=d;this.__lastTouchTop=a;this.__lastTouchMove=c;this.__lastScale=g}},doTouchEnd:function(a){a instanceof Date&&(a=a.valueOf());if("number"!==typeof a)throw Error("Invalid timestamp value: "+a);if(this.__isTracking){this.__isTracking=!1;if(this.__isDragging&&(this.__isDragging=!1,this.__isSingleTouch&&this.options.animating&&
...
e;b.__scheduledZoom=g;var j=b.__scrollLeft,v=b.__scrollTop,l=b.__zoomLevel,h=a-j,k=e-v,q=g-l;b.__isAnimating=core.effect.Animate.start(function(a,c,d){d&&(b.__scrollLeft=j+h*a,b.__scrollTop=v+k*a,b.__zoomLevel=l+q*a,b.__callback&&b.__callback(b.__scrollLeft,b.__scrollTop,b.__zoomLevel))},function(a){return b.__isAnimating===a},function(a,c){c===b.__isAnimating&&(b.__isAnimating=!1);b.options.zooming&&b.__computeScrollMax()},250,f?c:i)}else b.__scheduledLeft=b.__scrollLeft=a,b.__scheduledTop=b.__scrollTop=
e,b.__scheduledZoom=b.__zoomLevel=g,b.__callback&&b.__callback(a,e,g),b.options.zooming&&b.__computeScrollMax()},__computeScrollMax:function(a){null==a&&(a=this.__zoomLevel);this.__maxScrollLeft=Math.max(this.__contentWidth*a-this.__clientWidth,0);this.__maxScrollTop=Math.max(this.__contentHeight*a-this.__clientHeight,0)},__startDeceleration:function(){var a=this;if(a.options.paging){var c=Math.max(Math.min(a.__scrollLeft,a.__maxScrollLeft),0),f=Math.max(Math.min(a.__scrollTop,a.__maxScrollTop),0),
d=a.__clientWidth,b=a.__clientHeight;a.__minDecelerationScrollLeft=Math.floor(c/d)*d;a.__minDecelerationScrollTop=Math.floor(f/b)*b;a.__maxDecelerationScrollLeft=Math.ceil(c/d)*d;a.__maxDecelerationScrollTop=Math.ceil(f/b)*b}else a.__minDecelerationScrollLeft=0,a.__minDecelerationScrollTop=0,a.__maxDecelerationScrollLeft=a.__maxScrollLeft,a.__maxDecelerationScrollTop=a.__maxScrollTop;var i=a.options.snapping?4:0.1;a.__isDecelerating=core.effect.Animate.start(function(b,c,d){a.__stepThroughDeceleration(d)},
function(){return Math.abs(a.__decelerationVelocityX)>=i||Math.abs(a.__decelerationVelocityY)>=i},function(){a.__isDecelerating=!1;a.scrollTo(a.__scrollLeft,a.__scrollTop,a.options.snapping)})},__stepThroughDeceleration:function(a){var c=this.__scrollLeft+this.__decelerationVelocityX,f=this.__scrollTop+this.__decelerationVelocityY;if(!this.options.bouncing){var d=Math.max(Math.min(this.__maxScrollLeft,c),0);d!==c&&(c=d,this.__decelerationVelocityX=0);d=Math.max(Math.min(this.__maxScrollTop,f),0);
...
this.__maxDecelerationScrollTop-f),0!==a&&(this.__decelerationVelocityX=0>=a*this.__decelerationVelocityX?this.__decelerationVelocityX+0.03*a:0.08*a),0!==d&&(this.__decelerationVelocityY=0>=d*this.__decelerationVelocityY?this.__decelerationVelocityY+0.03*d:0.08*d))}},j;for(j in f)Scroller.prototype[j]=f[j]})();
