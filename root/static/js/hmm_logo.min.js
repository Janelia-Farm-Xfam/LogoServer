...
"#cccccc",this.contexts[d].fillRect(g,10,this.zoomed_column,this.height-40);else if(c=this.data.height_arr[h-1],l=[],c){for(var r=0,s=c.length,n=0,n=0;n<s;n++){var w=c[n].split(":",2),m=g+this.zoomed_column/2,v=null;if(0.01<w[1]){var v=parseFloat(w[1])/this.data.max_height,w=255-r,t=255*v;k()||(w+=t*(v/2));l[n]=[t,this.zoomed_column,m,w];r+=t}}for(n=s;0<=n;n--)l[n]&&this.letters[c[n][0]]&&this.letters[c[n][0]].draw(this.contexts[d],l[n][0],l[n][1],l[n][2],l[n][3])}f(this.contexts[d],g,this.height-
15,5);f(this.contexts[d],g,this.height-30,5);f(this.contexts[d],g,this.height-45,5);0.7>this.zoom?0===h%5&&this.draw_column_divider({context_num:d,x:g,fontsize:10,column_num:p,ralign:!0}):this.draw_column_divider({context_num:d,x:g,fontsize:q,column_num:p});c=this.data.delete_probs[h-1]/100;l=this.height-35;r="#ffffff";s="#555555";0.25<c?(r="#2171b5",s="#ffffff"):0.15<c?r="#6baed6":0.05<c&&(r="#bdd7e7");e(this.contexts[d],g,l,c,q,this.zoomed_column,r,s);c=this.contexts[d];l=g;r=this.height;s=this.zoomed_column;
n=this.data.insert_probs[h-1]/100;m=r-20;v="#ffffff";w="#555555";0.1<n?(v="#d7301f",w="#ffffff"):0.05<n?v="#fc8d59":0.03<n&&(v="#fdcc8a");e(c,l,m,n,q,s,v,w);0.03<n&&f(c,l+s,r-30,-30-r,v);c=this.data.insert_lengths[h-1];l="#ffffff";r="#555555";9<c?(l="#d7301f",r="#ffffff"):7<c?l="#fc8d59":4<c&&(l="#fdcc8a");e(this.contexts[d],g,this.height-5,c,q,this.zoomed_column,l,r);g+=this.zoomed_column;p++}b(this.contexts[d],this.height-15,this.total_width);b(this.contexts[d],this.height-30,this.total_width);
b(this.contexts[d],this.height-45,this.total_width);b(this.contexts[d],0,this.total_width)};this.draw_column_divider=function(c){var a=c.ralign?c.x+this.zoomed_column:c.x,b=c.ralign?c.x+2:c.x;f(this.contexts[c.context_num],a,this.height-30,-30-this.height,"#dddddd");f(this.contexts[c.context_num],a,0,5);var a=this.contexts[c.context_num],u=this.zoomed_column,e=c.column_num,d=c.ralign;a.font=c.fontsize+"px Arial";a.textAlign=d?"right":"center";a.fillStyle="#666666";a.fillText(e,b+u/2,10)};this.render_with_rects=
function(c,a,e,d){var g=0,p=c,h=0,h=Math.abs(this.data.max_height),l=Math.abs(this.data.min_height_obs),h=h+l,h=Math.round(100*Math.abs(this.data.max_height)/h);Math.round(256*h/100);l=10;for(h=c;h<=a;h++){if(this.data.mmline&&1===this.data.mmline[h-1])this.contexts[e].fillStyle="#cccccc",this.contexts[e].fillRect(g,10,this.zoomed_column,this.height-40);else{c=this.data.height_arr[h-1];for(var r=0,s=c.length,n=0,n=0;n<s;n++){var k=c[n].split(":",2);if(0.01<k[1]){var m=parseFloat(k[1])/this.data.max_height,
v=g,m=256*m,t=256-r-m;d?(this.contexts[e].strokeStyle=this.colors[k[0]],this.contexts[e].strokeRect(v,t,this.zoomed_column,m)):(this.contexts[e].fillStyle=this.colors[k[0]],this.contexts[e].fillRect(v,t,this.zoomed_column,m));r+=m}}}0.2>this.zoom?l=20:0.3>this.zoom&&(l=10);0===h%l&&(f(this.contexts[e],g+this.zoomed_column,this.height-30,parseFloat(this.height),"#dddddd"),f(this.contexts[e],g+this.zoomed_column,0,5),c=this.contexts[e],r=g-2,s=this.zoomed_column,n=p,c.font="10px Arial",c.textAlign=
...
c=b.data.probs_arr[e-1].slice(0).reverse();p=Math.ceil(c.length/5);for(h=0;h<p;h++)g=1<p&&h<p-1?g+('<th>Residue</th><th class="odd">'+l+"</th>"):g+("<th>Residue</th><th>"+l+"</th>");f.append(d(g+"</tr>"));for(h=0;5>h;h++){k+="<tr>";for(l=h;c[l];)g=c[l].split(":",2),k=1<p&&15>l?k+('<td class="'+b.alphabet+"_"+g[0]+'">'+g[0]+'</td><td class="odd">'+g[1]+"</td>"):k+('<td class="'+b.alphabet+"_"+g[0]+'">'+g[0]+"</td><td>"+g[1]+"</td>"),l+=5;k+="</tr>"}f.append(d(k));d(a.column_info).empty().append(d("<p> Column:"+
